          ...
          try {
            ...
            if (res.status === 200) {
             ...
             JSON.stringify(localStorage.setItem("loggedIn", true))
              ...
              // console.log("The balance is: " + data.token.userBalance)
...
<Card
        ...
        body = {show ? (
            ...
            <a href="#/deposit/"><button type='submit' className='btn btn-success'  style={{marginBottom:"10px", width: "80%"}}>Make A Deposit</button></a>            
            <a href="#/withdraw/"><button type='submit' className='btn btn-warning' style={{marginBottom:"10px", width: "80%"}} >Make A Withdraw</button></a>
            <a href="#/balance/"><button type='submit' className='btn btn-primary' style={{marginBottom:"10px", width: "80%"}} >Check My Balance</button></a>
            <button type='submit' className='btn btn-danger' style={{width: "80%"}} onClick={logOut}>Logout</button>
            </>
        )}
